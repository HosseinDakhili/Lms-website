...
const TestimonielsSection = () => {
  const comments = dummyTestimonial.map((testimonial, inedex) => {
    return (
      <div
        key={inedex}
  ...
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="grid grid-cols-1 md:px-33  md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
        {comments}
      </div>
    </div>
  );
