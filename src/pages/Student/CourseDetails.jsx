  ...
  return (
    ...
    <section className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        <h1 className="md:text-[40px] text-[32px] font-semibold text-gray-800">
        ...
        <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
          ...
          <p className="text-blue-600">
            ({courseData.courseRatings.lenght}
            {courseData.courseRatings.lenght > 1 ? "ratings" : "rating"})
          </p>
          <p>
            {courseData.enrolledStudents.lenght}
            {courseData.enrolledStudents.lenght > 1 ? "students" : "student"}
          </p>
        </div>
        <p className="text-sm">
        ...
        <div className="pt-6 text-gray-800">
          ...
          <div className="pt-5">
            {courseData.courseContent.map((chapter, index) => (
              <div
                className="boreder border-gray-300 bg-white mb-2 rounded"
                key={index}
              >
                <div
                  ...
                  <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                    {chapter.chapterContent.map((lecture, i) => (
                      <li className="flex items-start gap-2 py-1" key={i}>
                        ...
                        />
                        <div
                          className="flex items-center justify-between w-full text-gray=800 text-xs 
                        md:text-lg
                        "
                        >
      ...
      <div className="max-w-[424px]  z-10 shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] ">
        ...
        <div className="p-5">
          ...
          <div className="flex items-center text-sm md:text-lg gap-4 pt-2 md:pt-4 text-gray-5--">
          ...
          <div className="pt-6">
            <p className="md:tex-xl text-lg font-medium text-gray-800">What's in the course</p>
            <ul className="ml-4 pt-2 text-sm md:text-lg list-disc text-gra">
